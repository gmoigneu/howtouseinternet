...
learningObjectives:
  ...
  - Recognize fake accounts and fraudulent posts
...
6. **Contact bank/card company** - Dispute charges
7. **Report to payment app** - If used Venmo/Zelle/etc.
8. **File police report** - For identity theft
9. **Contact credit bureaus** - If identity compromised

**Account security:**

10. **Change passwords** - All accounts
11. **Enable 2FA** - If not already active
12. **Review account activity** - Check for unauthorized access
13. **Alert friends** - If account was compromised
