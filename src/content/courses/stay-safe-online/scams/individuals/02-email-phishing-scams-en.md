...
learningObjectives:
  ...
  - Understand different types of email scams targeting individuals
...
**The Setup:**
You receive an email claiming your account needs verification or will be suspended.
...
**The Setup:**
Email appears to be a receipt for a purchase you didn't make, hoping you'll click to dispute it.
...
**The Setup:**
Congratulations! You've won a prize, lottery, or gift card you never entered.
...
**The Setup:**
Email appears to be from your bank about suspicious activity or required updates.
...
**The Setup:**
Email claims to be from Microsoft, Apple, or antivirus companies about security issues.
...
- `noreply@paypal-secure.com`
- `security@microsoft-365.com`
- `alerts@bankofamerica.net` (should be .com)
...
**Step 1: Pause**
Don't click immediately, even if it seems urgent.
...
Review the checklist above—any red flags?

**Step 5: When in Doubt, Don't**
If something feels off, don't click. Delete it.
...
**Email received:**
```
From: Amazon <no-reply@amazon-services.net>
...
**Email received:**
```
From: Microsoft Security Team <alerts@microsoft-365.com>
...
6. **Report it** - Forward to phishing@company.com

**Within 24 hours:**

7. **Check bank statements** - Look for unauthorized charges
8. **Monitor credit** - Watch for identity theft signs
9. **Update passwords** - For accounts using same password
10. **Alert contacts** - If your email was compromised
